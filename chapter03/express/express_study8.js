...
app.use(session({
    ...
    resave: false,  //새로운 요청 시 세션에 변동사항 없어도 다시 저장할지 설정
...
//미들웨어 첫 부분에 next()를 넣어주어야 다음 미들웨어로 가는데~
//next()가 보이지 않는 이유는 내부에 내장되어 있기 때문.
//단 static에 경우 next()가 없으니 공동 미들웨어의 순서를 잘 설정해야함
